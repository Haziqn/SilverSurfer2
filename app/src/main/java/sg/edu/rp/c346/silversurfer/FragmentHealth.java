 ...
 * {@link FragmentHealth.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentHealth#newInstance} factory method to
...
//        return inflater.inflate(R.layout.fragment_health, container, false);
        View x =  inflater.inflate(R.layout.fragment_fragment_health,null);
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        {
            switch (position){
                case 0 : return new Health();
                case 1 : return new Fitness();
            }
            return null;
        }
