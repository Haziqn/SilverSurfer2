...
public class FragmentPhotos extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Photoes, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Photoes, BlogViewHolder>(
            ...
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Photoes model, int position) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                startActivity( new Intent(getActivity(), Upload_Photos.class));
                break;
        }
        return true;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_photos,
                container, false);
